...
│   │   │   │   ├── 📄 PopularSkillsChart.tsx
│   │   │   │   ├── 📄 RecentSessions.tsx
│   │   │   │   ├── 📄 SessionActivityChart.tsx
│   │   │   │   ├── 📄 SessionOverview.tsx
│   │   │   │   ├── 📄 SessionStatistics.tsx
│   │   │   │   ├── 📄 SessionStatusChart.tsx
│   │   │   │   └── 📄 UserGrowthChart.tsx
│   │   │   ├── 📁 sessions/
...
│   │   │   └── 📄 AdminUsersPage.tsx
│   │   ├── 📁 availability/
│   │   │   ├── 📄 AddAvailabilityForm.tsx
│   │   │   ├── 📄 AvailabilityHeader.tsx
│   │   │   ├── 📄 AvailabilityInfo.tsx
...
│   │   │   ├── 📄 SwapCardUser.tsx
│   │   │   ├── 📄 SwapPageSkeleton.tsx
│   │   │   └── 📄 rescheduleSessionUtils.ts
│   │   ├── 📁 ui/
│   │   │   ├── 📄 OfflineIndiactor.tsx
│   │   │   ├── 📄 button.tsx
│   │   │   ├── 📄 magic-card.tsx
│   │   │   └── 📄 table.tsx
│   │   ├── 📁 wallet/
