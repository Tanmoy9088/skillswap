...
const Footer = () => {
  return (
    <>
      {/* 7. FOOTER */}
      <footer className=" mx-auto px-6 sm:px-8 lg:px-12 py-8 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-gray-500">
        <div>
