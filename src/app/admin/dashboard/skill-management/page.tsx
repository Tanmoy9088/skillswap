...
import AdminAddSkillModal from "@/components/admin/AdminAddSkillModal";
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    Manage the skills available for SkillSwap+ users.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-2xl border bg-white p-5 shadow-sm">
              <div className="flex items-center justify-between">
                ...
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-green-100">
                  <Power size={19} className="text-green-600" />
                </div>
              </div>
            </div>
            ...
            <div className="rounded-2xl border bg-white p-5 shadow-sm">
              <div className="flex items-center justify-between">
                ...
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-100">
                  <Power size={19} className="text-gray-400" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-2xl border bg-white shadow-sm">
            ...
            {!skills || skills.length === 0 ? (
              <div className="flex min-h-80 flex-col items-center justify-center p-8 text-center">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Create your first skill to make it available to users.
                </p>
